...
<>
      <section className="container mx-auto px-6 py-12">
        <div className="text-center mb-10">
          <h1
            className="text-3xl sm:text-4xl font-extrabold text-pos-secondary"
          >选择您的帮助主题</h1>
...
<li key={sub.id}>
              ...
              >
                <div className="flex items-center mb-2">
                  <div
                    className="w-10 h-10 rounded-lg bg-pos-primary/10 text-pos-primary flex items-center justify-center mr-3"
                  >
                    <svg
                  ...
                  <h2
                    className="text-lg font-semibold text-pos-secondary group-hover:text-pos-primary"
                  >{sub.categoryName}</h2>
                </div>
